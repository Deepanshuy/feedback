...
const Login=()=>{
    ...
    return (
        <div className="w-screen flex justify-center items-center">
            <div className="w-[60%] h-[25rem] md:mt-32 mt-16  mx-auto  flex justify-center items-center overflow-hidden rounded-2xl  border-[#40afbf] border-4">
                   ...
                   <div className="flex  flex-col  justify-between p-4 w-[60%] h-full">
                       ...
                       <img src={logo} className="object-cover mx-auto" alt="login"/>
                        ...
                        <div>
                            <form action="" className="flex flex-col p-2 gap-y-4" >
                     ...
                     <Button variant="contained" size="small" className="!bg-[#40afbf] !w-full">log in</Button>
                     </Link>
                            </form>
